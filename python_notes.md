...
* **Security Application:** Storing system logs, IP addresses, and user permissions for analysis.
* **Syntax Rule:** Names should be descriptive (e.g., `user_ip = "192.168.1.1"`).

### 2. f-strings (Formatted String Literals)
* **What they are:** A way to embed expressions inside string literals using curly braces `{}`.
* **Why use them:** They make code more readable and allow for "Dynamic Reporting."
